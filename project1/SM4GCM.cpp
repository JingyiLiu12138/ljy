...
#include <windows.h>
using namespace std;
static const uint8_t Sbox[256] = { //SM4标准S-Box
...
static const uint8_t MK[16] = { //固定128 bits主密钥
...
static const uint32_t CK[32] = { //CK常量，用于加密
